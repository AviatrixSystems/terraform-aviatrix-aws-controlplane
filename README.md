...
| cop_controller_auth_ip        | public                                     | Controller IP to be used for authentication by CoPilot. CoPilot will make requests to either the public or the private IP of the controller   |
